...
<template>
  <div>
    ...
    <div v-if="loading" class="flex items-center justify-center h-64">
      <div
        class="animate-spin rounded-full h-10 w-10 border-b-2 border-brand-600"
      ></div>
    </div>
    ...
    <div v-else-if="stats">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        <div class="card p-6">
          <div class="flex items-center gap-4">
            <div
              class="w-12 h-12 bg-brand-100 rounded-xl flex items-center justify-center"
            >
              <svg
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div class="card">
          ...
          <div
            v-if="stats.recentPrices.length === 0"
          ...
          <ul v-else class="divide-y divide-gray-50">
            ...
            >
              ...
              <span class="font-semibold text-brand-700 whitespace-nowrap">{{
        ...
        <div class="card">
          ...
          <div
            v-if="stats.cheapestByProduct.length === 0"
            class="p-6 text-center text-gray-400 text-sm"
          >
